...
.themebtn{position:fixed;top:14px;right:14px;font-family:var(--mono);font-size:.72rem;background:var(--card);color:var(--ink);border:1px solid var(--rule);border-radius:100px;padding:6px 12px;cursor:pointer;z-index:20}
...
</style></head><body><button id="themebtn" class="themebtn" aria-label="Toggle light or dark theme">☾ Dark</button><div class="wrap">
...
(function(){
  ...
  btn.addEventListener('click',function(){
    ...
    try{ localStorage.setItem('yay-theme', next); }catch(e){}
    label();
  });
})();
</script>
