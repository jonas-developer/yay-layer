...
const COMMANDS = [
  ...
  { cmd: 'yay reverify · witness · metrics', desc: 'Append a fresh re-verification without rewriting history · write an integrity witness · earned-autonomy metrics (how delegated work has held up).', flags: [] },
