...
function header(method) {
  ...
  return [
    ...
    'tighter `in:` domains; the corrected clause; declared effects), present it, and get it RE-SIGNED, then',
    'reconcile the code. A signed-but-unproven Cell is a to-do, not a finish line. Run `yay adversary` when',
    'you want a spec-only LLM to hunt for weak spots to tighten.',
    '',
